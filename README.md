...
charge_power = min([net_power, battery_power_max, ...(battery_max_SOC - battery_SOC) *
battery_capacity]);
...
## OUTPUT
<img width="1919" height="901" alt="image" src="https://github.com/user-attachments/assets/751b3247-a642-4e89-8c83-bd7815a6b567" />

## RESULT
Thus the simulation of energy management algorithm using MATLAB is simulated
